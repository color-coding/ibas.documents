...
import { IDocumentListView } from "../../../bsapp/document/index";

/**
 * 视图-Document
 */
export class DocumentListView extends ibas.BOListView implements IDocumentListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        return bo.Document;
    }
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.Document>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    /*
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.Document>(that.table)
                            );
                        }
                    }),
                ],
