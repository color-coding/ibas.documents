...
import org.colorcoding.ibas.documents.MyConsts;
import org.colorcoding.ibas.documents.data.*;
...
@XmlType(name = Document.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = Document.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@BOCode(Document.BUSINESS_OBJECT_CODE)
public class Document extends BusinessObject<Document> implements IDocument {
    ...
    * 当前类型
    */
    private static final Class<?> MY_CLASS = Document.class;

    /**
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "AVA_DC_ODOC";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "AVA_DC_DOCUMENT";

    /**
    * 业务对象名称
    */
    public static final String BUSINESS_OBJECT_NAME = "Document";
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_FILESIGN = registerProperty(PROPERTY_FILESIGN_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_FILENAME = registerProperty(PROPERTY_FILENAME_NAME, String.class, MY_CLASS);
    ...
    */
    ...
    public static final IPropertyInfo<String> PROPERTY_TAGS = registerProperty(PROPERTY_TAGS_NAME, String.class, MY_CLASS);
